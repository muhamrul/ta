...
<html>
  ...
  $_SESSION['tabEvent'] = 0;
  $sqlKaryawan = "SELECT * FROM pengguna WHERE jabatan = 1 AND s_hapus = 0";
  ...
  ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  <div class="row">
            <div class="col-xs-12">
			  <p>
			  <button type="button" class="btn btn-primary" onclick="dataPenggunaTambah()" data-toggle="modal" data-target="#myModal">+ Tambah Panitia</button>
			  &nbsp;&nbsp;&nbsp;
	...
	<script>
        function dataPenggunaDetail(id){
			$("#modal-body").load("data_pengguna.php?idDetail="+id+"&user=1");
		} function dataPenggunaEdit(id){
			$("#modal-body").load("data_pengguna.php?idEdit="+id+"&user=1");
		} function dataPenggunaHapus(id){
			$("#modal-body").load("data_pengguna.php?idHapus="+id+"&user=1");
		} function dataPenggunaTambah(){
			$("#modal-body").load("data_pengguna.php?idTambah='A'&user=1");
		} function dataPenggunaRestore(){
			$("#modal-body").load("data_pengguna.php?restorHapus='A'&user=1");
		}
    </script>
  </body>
</html>