...
<html>
  ...
  $_SESSION['tabEvent'] = 0;
  $sqlKaryawan = "SELECT * FROM pengguna WHERE jabatan = 2 AND s_hapus = 0";
  ...
  ?>
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="pengunjung.php">Pengunjung</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  <div class="row">
            <div class="col-xs-12">
			  <p>
			  <button type="button" class="btn btn-primary" onclick="dataPenggunaTambah()" data-toggle="modal" data-target="#myModal">+ Tambah Pengunjung</button>
			  &nbsp;&nbsp;&nbsp;
	...
	<script>
        function dataPenggunaDetail(id){
			$("#modal-body").load("data_pengguna.php?idDetail="+id+"&user=2");
		} function dataPenggunaEdit(id){
			$("#modal-body").load("data_pengguna.php?idEdit="+id+"&user=2");
		} function dataPenggunaHapus(id){
			$("#modal-body").load("data_pengguna.php?idHapus="+id+"&user=2");
		} function dataPenggunaTambah(){
			$("#modal-body").load("data_pengguna.php?idTambah='A'&user=2");
		} function dataPenggunaRestore(){
			$("#modal-body").load("data_pengguna.php?restorHapus='A'&user=2");
		}
    </script>
  </body>
</html>